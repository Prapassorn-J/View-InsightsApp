            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <View style={{ margin: 15 }}>
                        ...
                        <View style={{ flexDirection: 'row', marginTop: -10, height: 50, width: 400, paddingHorizontal: 10, backgroundColor: '#C4C1A4', opacity: 0.9, borderRadius: 5, borderWidth: 1, borderColor: 'grey' }}>
